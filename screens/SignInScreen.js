...
import { Item, Card, CardItem, Form, Input, Button } from 'native-base';
...
export default class SignInScreen extends React.Component {
  ...
  loginWithEmail = (email, password) => {
    const my_email = email.trim().concat('@farmerRent.com');
    firebase
      .auth()
      .signInWithEmailAndPassword(my_email, password)
        ...
        <View>
          ...
          <Card style={styles.cardContainer}>
            ...
            <Form style={styles.formContainer}>
              ...
              <Button
                block
                style={[styles.loginButton, { marginLeft: 15 }]}
                onPress={() => {
            ...
            >
              <Text style={{ color: '#0A79DF', fontWeight: 'bold' }}>
                Create Account
              </Text>
            </TouchableOpacity>
          </Card>
