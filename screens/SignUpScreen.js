...
import { Item, Card, CardItem, Form, Input, Label, Button, Picker } from 'native-base'
...
export default class SignUpScreen extends React.Component {
  ...
  createUser =  () => {
    ...
    if(this.validateFields() !== false)
    {
      ...
      .then(async authenticate => {
        ...
        switch(userType){
            case "farmer":
              await dbReference.ref('users/farmers/')
              .push(user, error => {
                if(error)
              ...
              break;
            case "vendor": 
            await dbReference.ref('users/vendors/')
              .push(user, error => {
                if(error)
                  Alert.alert(error.message,"")
              })
  ...
  render() {
    return (
      ...
      <Text style={[styles.heading, {fontSize: 30, marginBottom: 10, textAlign: "center"}]}>
        Welcome
      </Text>
            ...
            <Form>
              ...
              <Item style={{borderBottomWidth: 0}}>
                <Picker
                  ...
                  mode="dropdown"
                  fontSize="18"
                  placeholderStyle={{color: "#4d4d51", justifyContent: "flex-start", fontSize: 18}}
                  placeholder="I am farmer/vendor &#x25bc;"
              ...
              <Button 
                  ...
                  <Text style={{color: "#D9AE3C", fontWeight: "bold"}}>Sign Up</Text>
              </Button>
            </Form>
        </Card>
        </View>
